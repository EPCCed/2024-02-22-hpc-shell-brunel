...
```bash
$ wget https://epcced.github.io/2024-01-18-hpc-shell-noc/files/bash-lesson.tar.gz
```
...
```bash
$ curl -O https://epcced.github.io/2024-01-18-hpc-shell-noc/files/bash-lesson.tar.gz
```
...
```bash
$ aria2c https://epcced.github.io/2024-01-18-hpc-shell-noc/files/bash-lesson.tar.gz
```
